    ...
    <>
      <div className="container mx-auto py-8">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-gray-600 mb-8" >Written by Omkar Halgi | June 23, 2023</p>
          ...
          <div className="prose">
            ...
            <div className="my-8">
              ...
              <pre className="bg-gray-100 p-4 rounded-lg relative">
                ...
                <button
                  className={`absolute top-2 right-2 px-3 py-1 rounded-md ${isCopied ? 'bg-green-500 text-white' : 'bg-blue-500 text-white'
                    }`}
                  onClick={handleCopy}
                >
