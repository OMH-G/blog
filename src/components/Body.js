      ...
      <div className="container px-5 py-24 mx-auto">
        <div className="flex flex-wrap -mx-4 -my-8">
          {Object.keys(post).map((item,index)=>{
            return(
          <div key={uuid()} className="py-8 px-4 lg:w-1/3" >
            <motion.div
            ...
            >
              ...
              <div className="flex-grow pl-6">
                ...
                >
                  <Link to={`Post${index+1}`} className='text-blue-500' >{post[item][4]}</Link>
                </motion.p>
                <motion.a
                  initial={{ opacity: 0, y: 10 }}
                  animate={{ opacity: 1, y: 0 }}
                ...
                >
                  ...
                  >
                    <span className="title-font font-medium text-gray-900">{post[item][5]}</span>
                  </motion.span>
                </motion.a>
              </div>
            </motion.div>
